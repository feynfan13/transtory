...
class CrhPublicData(object):
    ...
    # @staticmethod
    # def _add_and_type_in_range(dfTrns, typeL0Idx, typeL1Idx, typeL2Idx, typeL3Idx, startIdx, endIdx):
    #     idxCol = dfTrns.shape[0]
    #     typeL0 = trainTypeSystem.level0[typeL0Idx]
    #     typeL1 = typeL0.affiliates[typeL1Idx]
    #     # typeL2 = trainTypeSystem.level2[typeL2Idx]
    #     typeL2 = typeL1.affiliates[typeL2Idx]
    #     # typeL3 = trainTypeSystem.level1[typeL3Idx]
    #     for idx in range(startIdx, endIdx + 1):
    #         dfTrns.loc[idxCol, "SN"] = typeL1.doc + typeL2.doc + "-{:04d}".format(idx)
    #         dfTrns.loc[idxCol, "TypeL0"] = typeL0Idx
    #         dfTrns.loc[idxCol, "TypeL1"] = typeL1Idx
    #         dfTrns.loc[idxCol, "TypeL2"] = typeL2Idx
    #         dfTrns.loc[idxCol, "TypeL3"] = typeL3Idx
    #         idxCol += 1
    #
    ...
    #     trainTypeSystem = TrainTypeSystem()
    #     dfAllTrains = pd.DataFrame(columns=["SN", "TypeL0", "TypeL1", "TypeL2", "TypeL3"])

    #     # CRH
    #     idxL0, nodeL0 = trainTypeSystem.add_level0("CRH")
    #     # CRH1
    #     idxL1, nodeL1 = trainTypeSystem.add_level1(nodeL0, "CRH1")
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "A")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "200")
    #     # CRH1A 200
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 1001, 1040)
    #     # CRH1A 250
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "250")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 1081, 1168)
    #     # CRH1A-A
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "A-A")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "初代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 1169, 1191)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 1234, 1237)
    #     # CRH1B
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "B")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "1A头型")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 1041, 1045)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 1047, 1060)
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "1E头型")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 1076, 1080)
    #     # CRH1E
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "E")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "初代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 1061, 1072)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 1073, 1075)
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "1A-A头型&横向卧铺")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 1229, 1233)
    #     # CRH2
    #     idxL1, nodeL1 = trainTypeSystem.add_level1(nodeL0, "CRH2")
    #     # CRH2A
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "A")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "初代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2001, 2009)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2011, 2060)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2151, 2211)
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "统型")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2212, 2416)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2427, 2459)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2473, 2499)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 4001, 4071)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 4082, 4095)
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "2G头型")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2460, 2460)
    #     # CRH2B
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "B")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "初代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2111, 2120)
    #     # CRH2C
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "C")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "一阶段")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2062, 2067)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2069, 2090)
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "二阶段")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2091, 2110)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2141, 2149)
    #     # CRH2E
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "E")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "初代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2121, 2138)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2140, 2140)
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "2G头型")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2461, 2472)
    #     # CRH2G
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "G")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "初代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2417, 2426)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 4072, 4081)
    #     # CRH3
    #     idxL1, nodeL1 = trainTypeSystem.add_level1(nodeL0, "CRH3")
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "A")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "初代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5218, 5218)
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "C")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "初代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 3001, 3080)
    #     # CRH5
    #     idxL1, nodeL1 = trainTypeSystem.add_level1(nodeL0, "CRH5")
    #     # CRH5A
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "A")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "初代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5001, 5013)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5044, 5055)
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "二代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5056, 5140)
    #     # CRH5E
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "E")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "CJ1头型")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5201, 5205)
    #     # CRH5G
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "G")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "初代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5141, 5200)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5206, 5215)
    #     # CRH380
    #     idxL0, nodeL0 = trainTypeSystem.add_level0("CRH380")
    #     # CRH380A general
    #     idxL1, nodeL1 = trainTypeSystem.add_level1(nodeL0, "CRH380A")
    #     # CRH380A
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "初代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2501, 2537)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2539, 2540)
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "统型")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2641, 2807)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2809, 2817)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2819, 2827)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2829, 2912)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2921, 2925)
    #     # CRH380AL
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "L")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "一阶段")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2541, 2570)
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "L")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "二阶段")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2571, 2640)
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "L")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "E35")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 2913, 2920)
    #     # CRH380B
    #     idxL1, nodeL1 = trainTypeSystem.add_level1(nodeL0, "CRH380B")
    #     # CRH380BL
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "L")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "一阶段")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 3501, 3542)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5501, 5540)
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "二阶段")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 3543, 3570)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5541, 5545)
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "三阶段")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 3732, 3737)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5823, 5828)
    #     # CRH380BG
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "G")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "初代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5546, 5600)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5626, 5636)
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "统型")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5684, 5729)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5762, 5786)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5803, 5822)
    #     # CRH380B
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "统型")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 3571, 3731)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 3738, 3774)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5637, 5683)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5730, 5761)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5787, 5802)
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5829, 5888)
    #     # CRH380C
    #     idxL1, nodeL1 = trainTypeSystem.add_level1(nodeL0, "CRH380C")
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "L")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "初代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 5601, 5625)
    #     # CRH380D
    #     idxL1, nodeL1 = trainTypeSystem.add_level1(nodeL0, "CRH380D")
    #     idxL2, nodeL2 = trainTypeSystem.add_level2(nodeL1, "")
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "初代")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 1501, 1510)
    #     idxL3, nodeL3 = trainTypeSystem.add_level3(nodeL2, "统型")
    #     addSuccessiveTrains(dfAllTrains, idxL0, idxL1, idxL2, idxL3, 1511, 1585)
    #
    #     return trainTypeSystem, dfAllTrains
